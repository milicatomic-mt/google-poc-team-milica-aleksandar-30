            ...
            <div className="grid grid-cols-2 gap-6 max-w-4xl mx-auto">
              ...
              <div>
                <Select value={productCategory} onValueChange={setProductCategory}>
                  <SelectTrigger className="h-12 text-base bg-white/30 border border-gray-700 backdrop-blur-md shadow-sm hover:shadow-md hover:bg-white/40 transition-all duration-200 focus:ring-2 focus:ring-primary/50">
                ...
                {productCategory === 'custom' && (
                  <Input
                    ...
                    className="h-12 text-base bg-white/30 border border-gray-700 backdrop-blur-md shadow-sm hover:shadow-md hover:bg-white/40 transition-all duration-200 placeholder:text-gray-500 mt-4"
                  />
                )}
              </div>
              ...
              <div>
                <Input
                  ...
                  className="h-12 !text-base bg-white/30 border border-gray-700 backdrop-blur-md shadow-sm hover:shadow-md hover:bg-white/40 transition-all duration-200 placeholder:text-gray-400 placeholder:text-base focus:ring-2 focus:ring-primary/50"
                />
              </div>
            </div>
          </div>
        ...
        <footer className="container-padding pb-8 pt-4 flex-shrink-0">
          <div className="flex justify-center">
            ...
            >
              ...
              <svg className="w-[24px] h-[24px] ml-3 fill-white flex-shrink-0" viewBox="0 0 800 800" style={{minWidth: '24px', minHeight: '24px'}}>

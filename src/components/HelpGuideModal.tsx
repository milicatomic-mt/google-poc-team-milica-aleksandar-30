...
export const HelpGuideModal = () => {
  return (
    <Sheet>
      ...
      <SheetContent 
        side="left" 
        className="w-full sm:max-w-md bg-white/80 backdrop-blur-md border border-white text-foreground overflow-y-auto h-[calc(100vh-48px)] mt-6 ml-6 mb-6 rounded-lg p-12"
      >

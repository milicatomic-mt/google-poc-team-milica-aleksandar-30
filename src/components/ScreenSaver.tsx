      ...
      <div className="relative z-20 flex flex-col items-center justify-center min-h-screen text-center px-4 sm:px-6 md:px-8 pt-20">
        <div className="animate-content-appear relative -mt-32 sm:-mt-48 md:-mt-64 lg:-mt-72">
          ...
          <div className="mb-12">
            ...
            <p className="text-xs sm:text-xs md:text-sm lg:text-base xl:text-lg 2xl:text-xl text-muted-foreground font-medium max-w-xs sm:max-w-sm md:max-w-md lg:max-w-lg xl:max-w-xl mx-auto min-h-[2rem] sm:min-h-[2.5rem] lg:min-h-[3rem] xl:min-h-[3.5rem] flex items-center justify-center px-4">
              {displayedText}

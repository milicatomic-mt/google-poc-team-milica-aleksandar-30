...
const VideoScriptsPreview: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Main Container with Reference Layout */}
      <div className="px-8 pb-8 mt-12">
        <div className="max-w-7xl mx-auto">
          {/* Video Scripts Container - Following reference layout */}
          <div className="bg-gray-200 rounded-3xl p-8 shadow-lg">
            <div className="mb-8">
              <div className="flex items-center gap-3">
                <h2 className="text-3xl font-bold text-gray-900">Video Scripts</h2>
                <span className="bg-primary text-primary-foreground text-sm px-3 py-1 rounded-full font-semibold">1</span>
              </div>
            </div>
            
            {/* Two Side-by-Side Preview Containers */}
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              
              {/* Left Container - Instagram Preview */}
              <div className="bg-white rounded-2xl p-8 shadow-lg h-[600px] overflow-hidden">
                <div className="h-full flex flex-col">
                  <div className="mb-4">
                    <h3 className="text-xl font-bold text-gray-900 mb-2">Instagram Preview</h3>
                    <p className="text-gray-600 text-sm">See how your content appears on Instagram</p>
                  </div>
                  
                  <div className="flex-1 flex items-center justify-center">
                    <div className="bg-black rounded-lg shadow-lg overflow-hidden w-full max-w-xs h-[500px] relative">
                      <div className="bg-black text-white p-3">
                        <div className="flex items-center justify-between text-sm font-medium mb-3">
                          ...
                          <div className="flex items-center gap-1">
                            ...
                            <div className="w-5 h-2 bg-white rounded-sm ml-2"></div>
                          </div>
                        </div>
                      ...
                      <div className="bg-black text-white p-3">
                        ...
                        {/* Engagement */}
                        <div className="mb-1">
                          <span className="text-xs">Liked by <span className="font-semibold">craig_love</span> and <span className="font-semibold">44,686 others</span></span>
                        </div>
                        ...
                        <div className="text-xs">
                          <span className="font-semibold">joshua_l</span> {videoScripts && videoScripts.length > 0 
                            ...
                            : 'Check out this amazing new product launch! 🎧 #tech #music'
                          }
                        </div>
              ...
              {/* Right Container - TikTok Preview */}
              <div className="bg-white rounded-2xl p-8 shadow-lg h-[600px] overflow-hidden">
                <div className="h-full flex flex-col">
                  <div className="mb-4">
                    <h3 className="text-xl font-bold text-gray-900 mb-2">TikTok Preview</h3>
                    <p className="text-gray-600 text-sm">See how your content appears on TikTok</p>
                  </div>
                    ...
                    <div className="bg-black rounded-lg shadow-lg overflow-hidden w-full max-w-xs h-[500px] relative">
                      <div className="relative h-full">
                        ...
                        <div className="absolute inset-0">
                          ...
                          {/* Status Bar Overlay */}
                          <div className="absolute top-0 left-0 right-0 flex items-center justify-between text-white text-sm font-medium p-3 bg-gradient-to-b from-black/50 to-transparent">
                            <span>9:41</span>
                            <div className="flex items-center gap-1">
                              <div className="flex gap-0.5">
                              ...
                              <div className="w-5 h-2 bg-white rounded-sm ml-1"></div>
                            </div>
                          </div>

                          {/* TikTok Navigation */}
                          <div className="absolute top-8 left-0 right-0 flex items-center justify-center gap-4 text-white">
                            <button className="text-sm font-medium opacity-75">Following</button>
                            <button className="text-sm font-bold border-b border-white pb-1">For You</button>
                          </div>
                          ...
                          <div className="absolute right-3 bottom-24 flex flex-col gap-4">
                            ...
                            <div className="text-center">
                              ...
                              <span className="text-white text-xs font-bold drop-shadow-lg">83.2K</span>
                            </div>
                            ...
                            {/* Music Icon */}
                            <div className="w-10 h-10 rounded-full bg-gradient-to-br from-pink-500 to-purple-600 flex items-center justify-center animate-spin">
                              <div className="w-6 h-6 rounded-full bg-black"></div>
                            </div>
                          </div>

                          {/* Bottom Content */}
                          <div className="absolute bottom-16 left-0 right-12 p-3 text-white">
                            {/* User Info */}
                            <div className="flex items-center gap-2 mb-2">
                              <span className="font-bold text-sm drop-shadow-lg">TOMORROW X TOGETHER</span>
                              <div className="w-3 h-3 bg-blue-500 rounded-full flex items-center justify-center">
                                <span className="text-xs text-white">✓</span>
                              </div>
                            </div>
                          ...
                          {/* Bottom Navigation */}
                          <div className="absolute bottom-0 left-0 right-0 bg-black text-white py-3 px-2">
                            <div className="flex justify-around items-center">
                              ...
                              <div className="text-center">
                                <div className="w-8 h-6 bg-white rounded-md flex items-center justify-center">
          ...
          {/* Full Video Section - Optional, outside the main reference layout */}

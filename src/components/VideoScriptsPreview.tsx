...
const VideoScriptsPreview: React.FC = () => {
  ...
  return (
    <div className="h-screen bg-background overflow-hidden">
      ...
      {/* Content */}
      <div className="container mx-auto px-6 py-8 h-full overflow-y-hidden">
        <div className="max-w-6xl mx-auto space-y-8 h-full overflow-y-hidden">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                      ...
                      <div className="text-center">
                        ...
                        <div className="w-36 mx-auto bg-black rounded-2xl overflow-hidden shadow-xl relative">
                          <div className="aspect-[9/19.5] relative bg-black overflow-hidden">
                            {/* Status Bar */}
                      ...
                      <div className="text-center">
                        ...
                        <div className="w-36 mx-auto bg-black rounded-2xl overflow-hidden shadow-xl relative">
                          <div className="aspect-[9/19.5] relative bg-white overflow-hidden">
                            {/* Status Bar */}
                            <div className="absolute top-1 left-3 right-3 flex justify-between items-center z-20">

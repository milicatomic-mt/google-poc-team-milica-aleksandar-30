      ...
      <div className="relative z-10 flex min-h-screen flex-col overflow-y-auto">
        ...
        <main className="flex-1 container-padding pt-4 pb-8">
          <div className="max-w-4xl mx-auto space-y-6">
            ...
            <Card className="card-elegant backdrop-blur-md bg-white/30 border-white/50 border-2 shadow-elegant-lg hover:shadow-elegant-lg transition-all duration-smooth">

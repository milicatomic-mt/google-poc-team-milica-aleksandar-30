          ...
          <div className="max-w-6xl mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              >
                <div className="px-4 py-3 flex items-center justify-between transition-all duration-smooth">
                  <div className="flex items-center space-x-2">
                    <h3 className="text-foreground font-medium">TikTok</h3>
                ...
                <CardContent className="p-4">
                  <div className="h-80 flex items-center justify-center">
                    ...
                    <div className="w-48 h-80 bg-black rounded-3xl shadow-2xl overflow-hidden relative border-4 border-gray-800">
                      {/* TikTok Header */}
                      ...
                      {/* Video Area - Blue/Teal Background */}
                      <div className="flex-1 bg-gradient-to-br from-teal-300 to-cyan-400 relative">
                        {/* Generate Video Content Overlay */}
                        <div className="absolute inset-0 flex flex-col items-center justify-center">
                          {/* Play Button */}
                          <div className="w-16 h-16 bg-white/20 rounded-full flex items-center justify-center backdrop-blur-md border border-white/30 mb-4">
                            <Play className="w-8 h-8 text-white ml-1" />
                          </div>
                          
                          {/* Generate Video Text */}
                          <div className="text-center px-4">
                            <h3 className="text-white text-sm font-bold mb-2">Generate Video Content</h3>
                            <p className="text-white/80 text-xs">Create engaging TikTok videos from your campaign</p>
                          </div>
                        </div>
                        
                        {/* TikTok UI Elements */}
                        <div className="absolute bottom-4 left-4 text-white">
                          <div className="text-xs font-medium">@YourBrand</div>
                          <div className="text-xs opacity-80">#trending #viral #products</div>
                        </div>
                      ...
                      <div className="bg-black p-3 flex justify-center items-center space-x-8">
                        <div className="text-white/60 text-xs">🏠</div>
                        <div className="text-white/60 text-xs">🔍</div>
                        <div className="w-8 h-6 bg-gradient-to-r from-pink-500 to-blue-500 rounded-lg flex items-center justify-center">
              ...
              >
                <div className="px-4 py-3 flex items-center justify-between transition-all duration-smooth">
                  <div className="flex items-center space-x-2">
                    <h3 className="text-foreground font-medium">Instagram</h3>
                    <span className="bg-muted text-primary text-xs px-2 py-1 rounded-full font-medium">1</span>
                  </div>
                </div>
                <CardContent className="p-4">
                  <div className="h-80 flex items-center justify-center">
                    ...
                    <div className="w-48 h-80 bg-black rounded-3xl shadow-2xl overflow-hidden relative border-4 border-gray-800">
                      ...
                      {/* Stories Section */}
                      <div className="bg-black px-3 py-2 flex space-x-3 border-b border-gray-800">
                        <div className="flex flex-col items-center">
                      ...
                      <div className="flex-1 bg-gradient-to-br from-teal-300 to-cyan-400 relative">
                        ...
                        <div className="absolute inset-0 flex flex-col items-center justify-center">
                          ...
                          <div className="text-center px-4">
                            <h3 className="text-white text-sm font-bold mb-2">Generate Video Content</h3>
                            <p className="text-white/80 text-xs">Create Instagram Reels from your campaign</p>
                          </div>
                        </div>
                      ...
                      <div className="bg-black border-t border-gray-800 p-3 flex justify-center items-center space-x-12">
                        <div className="text-white text-lg">🏠</div>

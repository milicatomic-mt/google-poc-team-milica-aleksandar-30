      ...
      case 'Video Scripts':
        ...
        return (
          <div className="max-w-4xl mx-auto space-y-8">
            {/* Single Video Script Example */}
            <div className="border-2 border-border rounded-xl overflow-hidden bg-background shadow-xl">
              ...
              <div className="bg-gradient-to-br from-gray-900 to-black text-white relative">
                ...
                <div className="relative aspect-video">
                  ...
                  <div className="absolute inset-0 flex items-center justify-center">
                    <div className="w-20 h-20 bg-white/10 rounded-full flex items-center justify-center backdrop-blur-md border border-white/20 hover:bg-white/20 transition-all duration-300">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-xl border border-gray-100">
              <div className="text-center mb-8">
                <h3 className="font-bold text-2xl text-gray-900 mb-3">Perfect for All Platforms</h3>
                <p className="text-gray-600 text-lg">This script is optimized and ready to deploy across all major social media platforms</p>
              </div>
              
              {/* Social Platform Icons */}
              <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                <div className="group text-center p-6 rounded-2xl bg-gradient-to-br from-pink-50 to-purple-50 hover:from-pink-100 hover:to-purple-100 transition-all duration-300 cursor-pointer">
                  ...
                  <h4 className="font-semibold text-lg text-gray-900 mb-2">TikTok</h4>
                  <p className="text-sm text-gray-600">9:16 Vertical format</p>
                </div>
                
                <div className="group text-center p-6 rounded-2xl bg-gradient-to-br from-purple-50 to-pink-50 hover:from-purple-100 hover:to-pink-100 transition-all duration-300 cursor-pointer">
                  ...
                  <h4 className="font-semibold text-lg text-gray-900 mb-2">Instagram</h4>
                  <p className="text-sm text-gray-600">Stories & Reels ready</p>
                </div>
                
                <div className="group text-center p-6 rounded-2xl bg-gradient-to-br from-red-50 to-pink-50 hover:from-red-100 hover:to-pink-100 transition-all duration-300 cursor-pointer">
                  <div className="w-16 h-16 mx-auto mb-4 bg-gradient-to-r from-red-500 to-pink-500 rounded-2xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                    <svg className="w-8 h-8 text-white" viewBox="0 0 24 24" fill="currentColor">
                      <path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/>
                    </svg>
                  </div>
                  <h4 className="font-semibold text-lg text-gray-900 mb-2">YouTube</h4>
                  <p className="text-sm text-gray-600">Shorts & standard format</p>
                </div>
                
                <div className="group text-center p-6 rounded-2xl bg-gradient-to-br from-blue-50 to-cyan-50 hover:from-blue-100 hover:to-cyan-100 transition-all duration-300 cursor-pointer">
                  ...
                  <h4 className="font-semibold text-lg text-gray-900 mb-2">Twitter</h4>
                  <p className="text-sm text-gray-600">Video tweets optimized</p>
                </div>
              </div>
              ...
              <div className="mt-8 p-6 bg-gradient-to-r from-blue-50 to-purple-50 rounded-2xl">
                <div className="flex items-center justify-center gap-3 mb-4">
                  ...
                  <h4 className="font-semibold text-lg text-gray-900">Universal Compatibility</h4>
                </div>
                <p className="text-center text-gray-600">
                  This script adapts seamlessly to each platform's unique format requirements and audience expectations, maximizing engagement across all channels.
                </p>
              </div>
            </div>
          </div>

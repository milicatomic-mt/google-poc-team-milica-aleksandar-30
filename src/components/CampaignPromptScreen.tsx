      ...
      <div className="relative z-10 flex h-screen flex-col">
                   ...
                   <button
                     ...
                     disabled={isAutoSelecting}
                          ...
                          selectedAudiences.includes(age)
                             ...
                             : 'bg-transparent border border-gray-300 text-black hover:bg-white/10 hover:scale-[1.02] transform scale-100 font-normal'
        ...
        <footer className="container-padding pb-8 pt-4 flex-shrink-0 border-t border-white/10 backdrop-blur-sm">
          <div className="flex justify-center">
            ...
            >
              <svg className="w-16 h-16 mr-2 fill-current" viewBox="0 0 24 24" fill="currentColor">
